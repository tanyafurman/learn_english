...
/**
 * Класс User хранит информацию о состоянии прогресса пользователя.<br>
 * <br>
 * <br>
 * Данный класс хранит такие данные, как:<br>
 * 1) имя, фамилию.<br>
 * 2) логин и пароль без доступа к ним.<br>
 * 3) количество повторений слова для изучения (rate).<br>
 * 4) количество изучаемых слов для прохождения теста.<br>
 * 5) список со словами для изучения. <br>
 * <br>
 * <br>
 * Класс User имеет список листенеров, то есть список классов, которые имееют связь с классом User и рассылает им информацию о изменениях:<br>
